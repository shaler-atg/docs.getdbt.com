...
So when an agent was asked *"how do I configure incremental models?"*, it improvised or used training data, pattern matching, best guess. The docs existed. A direct path to them, to the canonical source, didn't.
...
- After: ask Claude or your AI tool directly, get an answer grounded in actual current documentation, keep coding! Docs 🤝 canonical source.
